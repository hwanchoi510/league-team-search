...
function Player({ player_info, runes, spells, champs }) {
    ...
    var spell_link = `https://ddragon.leagueoflegends.com/cdn/12.22.1/img/spell/`;
    ...
    return (
        <div className={team === 100 ? 'player_blue' : 'player_red'}>
            ...
            <img src={`https://ddragon.leagueoflegends.com/cdn/12.22.1/img/champion/${champion}.png`} alt={champion} className='player_champion_icon' />
